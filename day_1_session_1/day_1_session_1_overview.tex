...
Download the slides and other materials for this bootcamp by: \vspace{-.8cm}
\begin{spaceitemize}
\item visiting the bootcamp Canvas page 
\item visiting the bootcamp GitHub page (\url{http://bit.ly/SPHbootcamp})
\begin{spaceitemize}
\item Download materials using the green ``Clone or Download'' button (choose download)
